...
export const Home: React.FC<HomeProps> = ({
  ...
  return (
    <div className="w-full h-full overflow-y-auto p-4 sm:p-6 max-w-lg mx-auto space-y-4 sm:space-y-5">
      ...
      {/* Admin or Student Status Banner with Live Cloud Sync */}
      {isAdmin ? (
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-emerald-200/60 dark:bg-emerald-900/60 text-emerald-800 dark:text-emerald-300 font-bold">
                  Verified Owner
                </span>
              </div>
              <p className="text-[11px] text-emerald-700 dark:text-emerald-400 flex items-center gap-1 mt-0.5">
                ...
                <span>All words you add sync live across every learner device</span>
              </p>
            </div>
          </div>
          {onOpenAddWord && (
        ...
        <div className="p-3 rounded-2xl bg-stone-50 dark:bg-stone-900/80 border border-stone-200 dark:border-stone-800 flex items-center justify-between gap-3 shadow-xs">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-stone-500 dark:text-stone-400">
                You receive newly published vocabulary words instantly
              </p>
            </div>
          </div>
          {onOpenAdminAuth && (
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-300 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-white dark:hover:bg-stone-800 text-[11px] font-bold flex items-center gap-1 transition-colors shrink-0 cursor-pointer"
            >
